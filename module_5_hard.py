...
class User:
    """
    Создаем класс User и определяем его атрибуты и спец.методы для класса:
...
class UrTube:
    """
    Создаем класс UrTube и определяем его атрибуты - списки (users, videos, current_user) и определяем спец.метод для класса и функции:
    __init__ - конструктор класса, вызывается при создании
